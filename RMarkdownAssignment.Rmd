...
> "Be at peace with the things you can't change." -Raye

[more info about this quote](https://americansongwriter.com/the-meaning-behind-escapism-by-raye-ft-070-shake-and-how-she-turned-real-life-trauma-into-creative-catharsis/)

## My Semester 

|Course Number|Course Title|Instructor Name|
|:------------|:-----------|:--------------|
|__MATH 2402__|_Calculus II_|Plamen Simeonov|
|__CS 1411__|_Computer Science_|Joseph Kamto|
...
```
Rewrote a version of Dolly Parton's "Jolene" that is very fun. 
```
